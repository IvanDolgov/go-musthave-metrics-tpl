...
// Тесты для обработчика updateJsonMetrics
func TestUpdateJsonMetricsHandler(t *testing.T) {
	storage := NewMemStorage()
	handler := updateJsonMetrics(storage)
...
// Тесты для обработчика getJsonMetricValue
func TestGetJsonMetricValueHandler(t *testing.T) {
	storage := NewMemStorage()
	...
	handler := getJsonMetricValue(storage)
...
func TestUpdateJsonMetricsResponse(t *testing.T) {
	storage := NewMemStorage()
	handler := updateJsonMetrics(storage)
